...
class BranchFocusVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cell = tableView.dequeueReusableCell(withIdentifier: "BranchInfoCell", for: indexPath) as? BranchInfoCell {
            ...
            let manager = messages?[indexPath.row].managerInfo
            
                   cell.subjectTitle.text = item
                   cell.managerName.text = manager
